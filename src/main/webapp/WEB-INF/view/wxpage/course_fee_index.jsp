<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*,com.qmmt.edu.util.*,com.qmmt.edu.pojo.*,com.qmmt.edu.persistence.*" %>
<%
...
<html>
	<head>
		...
		<meta name="sharecontent" data-msg-img="http://edu.gdzqyz.cn/qmqrcode.jpeg" data-msg-title="园众学校的网上直播" data-msg-content="青苗麦田教育平台围绕学习诊断、课堂教学、课后作业、培优补差、设问答疑、学习社交等学习生活，为教师和学生提供线上面对面的教育模式" data-msg-callBack="" data-line-img="http://edu.gdzqyz.cn/qmqrcode.jpeg" data-line-title="青苗麦田的网上直播" data-line-callBack=""/>
		<title>直播课</title>
	...
	<body style="background: #e5e5e5;">
		...
		<!--英语-->
			<div class="content-group newgroup">
				...
				<%for(EduCoursePojo eduCoursePojo: yyList){ 
				if(eduCoursePojo.getCourseType() == null || eduCoursePojo.getCourseType() !=1){%>
				...
				<div class="addborder">
					...
					<div class="more pull-right" style="width: 70%;">
						<p><strong><%=eduCoursePojo.getCourseName() %></strong><%if(eduCoursePojo.getCloseTime().getTime()>System.currentTimeMillis()){ %><img src="http://edu.gdzqyz.cn/new1.jpg" width="25"/><%} %></p>
						...
						<p><%if(eduCoursePojo.getMarketCourseFee() != null){%><s><font color="red">原价<%=eduCoursePojo.getMarketCourseFee() %>元</font></s>  <%}%><%=eduCoursePojo.getCourseFee().toString() %>元（<%=eduCoursePojo.getCourseNum() %>节）</p>
					</div>
				</div>
				</a>
				<%}else{%>
				...
				<div class="addborder">
					...
					<div class="more pull-right" style="width: 70%;">
						<p><strong><%=eduCoursePojo.getCourseName() %></strong><%if(eduCoursePojo.getCloseTime().getTime()>System.currentTimeMillis()){ %><img src="http://edu.gdzqyz.cn/new1.jpg" width="25"/><%} %></p>
						<p><%=eduCoursePojo.getRemark() %></p>
						<p>已报名<%=eduCoursePojo.getOrderNum() %>人</p>
					</div>
				</div>
				</a>
				<%}} %>
			...
			<div class="content-group newgroup">
				<h3 style="border-bottom: 1px solid #CCCCCC; line-height: 3rem;">
				  ...
				  <a href="/qmmtedu/course/course_list.htm?ctype=1" class="pull-right">更多></a>
				</h3>
			...
			<div class="content-group newgroup">
				<h3 style="border-bottom: 1px solid #CCCCCC; line-height: 3rem;">
				  ...
				  <a href="/qmmtedu/course/course_list.htm?ctype=2" class="pull-right">更多></a>
				</h3>
			...
			<div class="content-group newgroup">
				<h3 style="border-bottom: 1px solid #CCCCCC; line-height: 3rem;">
					<img src="img/1_11.jpg" alt=""  style="width: 2rem;" /> 益智
				  <a href="#" class="pull-right">更多></a>
				</h3>
				<%for(EduCoursePojo eduCoursePojo: yzList){ %>
				<a href="/qmmtedu/course/course_detail.htm?course_id=<%=eduCoursePojo.getId()%>">
				<div class="addborder">
					<div class="prise pull-left" style="width: 29%;">
						<img src="<%=eduCoursePojo.getImgUrl() %>" alt="老师照片" style="max-width: 100%; height: 6rem;" class="pull-left"/>
