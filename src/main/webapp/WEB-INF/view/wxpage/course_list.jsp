...
<%
List<EduCoursePojo> cList = (List<EduCoursePojo>)request.getAttribute("cList");
String cname = "语文";
if("1".equals(request.getParameter("ctype"))) {
	cname = "语文";
} else if("2".equals(request.getParameter("ctype"))) {
	cname = "美术";
}
		...
		<div class="main">
			...
			<div class="content-group newgroup">
				<h3 style="border-bottom: 1px solid #CCCCCC; line-height: 3rem;">
					<img src="img/1_03.jpg" alt=""  style="width: 2rem;" /> <%=cname %>
				  
				<%for(EduCoursePojo eduCoursePojo: cList){ 
				...
				<div class="addborder">
					...
					<div class="more pull-right" style="width: 70%;">
						<p><strong><%=eduCoursePojo.getCourseName() %></strong><%if(eduCoursePojo.getOpenTime().getTime()>System.currentTimeMillis()){ %><img src="http://edu.gdzqyz.cn/new1.jpg" width="25"/><%} %></p>
